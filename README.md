...
- [Isolated access rights to Key Vault](#isolated-access-rights-to-key-vault)
...
Isolated access rights design means better security.
...
If you are not on [Express](https://expressjs.com/), you can consider porting it to platform of your choice. It is [about 70 lines only](https://github.com/compulim/acme-http-01-azure-key-vault-middleware/blob/main/src/middleware/express.js).
